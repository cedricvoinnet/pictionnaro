package com.example.pictionnaro.pictionnaro.Views;
...
import com.example.pictionnaro.pictionnaro.Models.Point;
...
public class DrawingView extends View {
    ...
    protected void onSizeChanged(int w, int h, int oldW, int oldH) {
        Log.e("TEST", "ON SIZE CHANNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNEGD!!!! w=" + w + " h=" + h + " oldw=" + oldW + "oldH=" + oldH + " mCanvasW=" + mCanvasWidth + " mCanvasHeight=" + mCanvasHeight);
